...
class Classroom{
    ...
    removeStudent = (id: number,arrayStudents: Student[]) => {
        ...
        if(student){
            ...
            const index = this.students.findIndex(ele => ele.getId() === student.getId())
    ...
    editStudent = (id :number,newId: number,newName: string) => {
...
classRoom1.removeStudent(3,arrayStudents);
classRoom1.editStudent(2,10,`Nguyen Van X`);
